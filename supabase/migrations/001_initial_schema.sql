...
-- 2. Check constraints (drop first, then add)
alter table children
...
create policy "lumix_classes_select" on classes
  for select to authenticated using (true);
create policy "lumix_classes_insert" on classes
  for insert to authenticated with check (true);
create policy "lumix_classes_update" on classes
  for update to authenticated using (true);
create policy "lumix_classes_delete" on classes
...
create policy "lumix_children_select" on children
  for select to authenticated using (true);
create policy "lumix_children_insert" on children
  for insert to authenticated with check (true);
create policy "lumix_children_update" on children
  for update to authenticated using (true);
create policy "lumix_children_delete" on children
  for delete to authenticated using (true);
...
create policy "lumix_activities_select" on activities
  for select to authenticated using (true);
create policy "lumix_activities_insert" on activities
  for insert to authenticated with check (true);
create policy "lumix_activities_update" on activities
  for update to authenticated using (true);
create policy "lumix_activities_delete" on activities
  for delete to authenticated using (true);
...
create policy "lumix_attendance_select" on attendance
  for select to authenticated using (true);
create policy "lumix_attendance_insert" on attendance
  for insert to authenticated with check (true);
create policy "lumix_attendance_update" on attendance
  for update to authenticated using (true);
create policy "lumix_attendance_delete" on attendance
  for delete to authenticated using (true);
